            ...
            child: Column(
              children: [
                ...
                Text('\$${Provider.of<AppData>(context).earnings}',
                  style: TextStyle(color: Colors.white, fontSize: 40, fontFamily: 'Brand-Bold'),)
              ],
            ),
          ),
        ),
          ...
          child: Padding(
            ...
            child: Row(
              children: [
                ...
                Expanded(child: Container(child: Text('3', textAlign: TextAlign.end, style: TextStyle(fontSize: 18),),)),
              ],
            ),
          ),
        ),
